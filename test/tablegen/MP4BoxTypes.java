...
public class MP4BoxTypes {
	...
	private static final String[][] NAMES = {
		...
		{"PUBLICATION_YEAR_BOX", "©day", "BoxImpl", "Publication Year Box"},
		...
		{"TELEVISION_SHOW_BOX", "tvsh", "BoxImpl", "Television Show Box"},
		...
		{"TELEVISION_SHOW_SORT_BOX", "sosn", "BoxImpl", "Television Show Sort Box"},
		...
		{"sample entries"},
		{"VIDEO_SAMPLE_ENTRY", "mp4v", "VideoSampleEntry"},
		{"H263_SAMPLE_ENTRY", "s263", "VideoSampleEntry"},
		{"AVC_SAMPLE_ENTRY", "avc1", "VideoSampleEntry"},
		{"AUDIO_SAMPLE_ENTRY", "mp4a", "AudioSampleEntry"},
