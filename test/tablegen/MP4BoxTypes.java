...
public class MP4BoxTypes {
	...
	private static final String[][] NAMES = {
		{"standard boxes"},
		{"ADDITIONAL_METADATA_CONTAINER_BOX", "meco", "ContainerBoxImpl.class", "Additional Metadata Container Box"},
		...
		{"DATA_INFORMATION_BOX", "dinf", "ContainerBoxImpl.class", "Data Information Box"},
		{"DATA_REFERENCE_BOX", "dref", "DataReferenceBox.class"},
		{"DEGRADATION_PRIORITY_BOX", "stdp", "DegradationPriorityBox.class"},
		{"EDIT_BOX", "edts", "ContainerBoxImpl.class", "Edit Box"},
		...
		{"MEDIA_BOX", "mdia", "ContainerBoxImpl.class", "Media Box"},
		...
		{"MOVIE_FRAGMENT_BOX", "moof", "ContainerBoxImpl.class", "Movie Fragment Box"},
		...
		{"SAMPLE_TABLE_BOX", "stbl", "ContainerBoxImpl.class", "Sample Table Box"},
		...
		{"TRACK_BOX", "trak", "ContainerBoxImpl.class", "Track Box"},
		{"TRACK_EXTENDS_BOX", "trex", "TrackExtendsBox.class"},
		{"TRACK_FRAGMENT_BOX", "traf", "ContainerBoxImpl.class", "Track Fragment Box"},
		...
		{"USER_DATA_BOX", "udta", "ContainerBoxImpl.class", "User Data Box"},
		...
		{"itunes"},
		{"ITUNES_META_LIST_BOX", "ilst", "ContainerBoxImpl.class", "iTunes Meta List Box"},
		{"TRACK_NAME_BOX", "©nam", "ContainerBoxImpl.class", "Track Name Box"},
		{"ARTIST_NAME_BOX", "©ART", "ContainerBoxImpl.class", "Artist Name BOx"},
		{"ALBUM_ARTIST_NAME_BOX", "aART", "ContainerBoxImpl.class", "Album Artist Name Box"},
		{"ALBUM_NAME_BOX", "©alb", "ContainerBoxImpl.class", "Album Name Box"},
		{"GROUPING_BOX", "©grp", "ContainerBoxImpl.class", "Grouping Box"},
		{"PUBLICATION_DATE_BOX", "©day", "ContainerBoxImpl.class", "Publication Date Box"},
		{"TRACK_NUMBER_BOX", "trkn", "ContainerBoxImpl.class", "Track Number Box"},
		{"DISK_NUMBER_BOX", "disk", "ContainerBoxImpl.class", "Disk Number Box"},
		...
		{"ARTIST_SORT_BOX", "soar", "ContainerBoxImpl.class", "Artist Sort Box"},
		{"ALBUM_ARTIST_SORT_BOX", "soaa ", "ContainerBoxImpl.class", "Album Artist Sort Box"},
		{"ALBUM_SORT_BOX", "soal", "ContainerBoxImpl.class", "Album Sort Box"},
		{"COMPOSER_SORT_BOX", "soco", "ContainerBoxImpl.class", "Composer Sort Box"},
		{"TELEVISION_SHOW_SORT_BOX", "sosn", "ContainerBoxImpl.class", "Television Show Sort Box"},
